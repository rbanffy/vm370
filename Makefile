...
build: ## Builds the Docker images
	...
	docker build -t ${USER}/vm370:latest-riscv64 --platform=linux/riscv64 .
...
upload_images: build ## Uploads the docker images
	...
	docker image push ${USER}/vm370:latest-riscv64
...
upload: upload_images ## Uploads the manifest
	docker manifest create ${USER}/vm370:latest \
		...
		--amend ${USER}/vm370:latest-riscv64 \
